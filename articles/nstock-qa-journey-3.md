...
前回実施した[品質レベルを考えるワークショップ](https://zenn.dev/nstock/articles/nstock-qa-journey-2)では、品質を考えるうえで軸になりそうな概念が洗い出せました。

今回は普段の意思決定に品質レベルの考えを活かせるよう、「インシデントレベル」を考えることにしました。
...
QAのプロにわかりやすくこれからやることの必要性をお話しいただくことで、全員の向かう方向が揃えられた気がします。
...
優先度が低く、Postmortemに残っていないこともあり、基準の議論が難しかった。バックログのBugラベルを持つチケットをピックアップしたらよかった


### インシデントレベルをマッピングする中で軸としてできたもの

- P1: 即時修正
    - 影響が前テナントにあり、コミュニケーションコストが高い
    - 権利者に対して案内が必要
    - 代替手段がない
...
これからの障害対応の経験や、プロダクトの成長に伴って、この決定フローは変わっていくことを期待しています。
